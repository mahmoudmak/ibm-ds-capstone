...
def get_scatter_chart(entered_site, slider_range):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df1, x="Payload Mass (kg)", y="class", color='Booster Version Category', hover_data=['Booster Version'],
        ...
        fig = px.scatter(filtered_df2, x="Payload Mass (kg)", y="class", color='Booster Version Category', hover_data=['Booster Version'],
